...
## Versao pronta para Jira

Use esta tabela como base para criacao manual no Jira ou para copia em massa.

| Issue Type | Epic Name | Summary | Priority | Story Points |
|---|---|---|---|---|
| Epic | Autenticacao e Perfil | EPIC-01 - Autenticacao e Perfil | Highest | |
| Story | Autenticacao e Perfil | Cadastro com onboarding de preferencias e restricoes alimentares | Highest | 5 |
| Story | Autenticacao e Perfil | Login social com Google e Apple | Highest | 8 |
| Story | Autenticacao e Perfil | Login biometrico/facial para acesso rapido | High | 5 |
| Epic | Receitas e Conteudo | EPIC-02 - Receitas e Conteudo | Highest | |
| Story | Receitas e Conteudo | Cadastro de receita com ingredientes, passos e fotos | Highest | 8 |
| Story | Receitas e Conteudo | Cadastro de receita com video curto de ate 8 segundos | High | 8 |
| Story | Receitas e Conteudo | Avaliacao de receitas com estrelas e comentario | Highest | 3 |
| Story | Receitas e Conteudo | Avaliacao de receitas com foto do resultado | High | 5 |
| Story | Receitas e Conteudo | Livro de receitas digital com colecoes personalizadas | High | 5 |
| Story | Receitas e Conteudo | Historico de receitas preparadas com notas | Highest | 3 |
| Story | Receitas e Conteudo | Conversao automatica de medidas por ingrediente | High | 8 |
| Story | Receitas e Conteudo | Calculo de custo total e custo por porcao | High | 5 |
| Story | Receitas e Conteudo | Informacao nutricional por porcao via API publica | High | 8 |
| Epic | Planejamento e Lista de Compras | EPIC-03 - Planejamento e Lista de Compras | Highest | |
| Story | Planejamento e Lista de Compras | Planejador semanal de refeicoes com drag and drop | Highest | 8 |
| Story | Planejamento e Lista de Compras | Geracao automatica de lista de compras pelo planejamento | Highest | 8 |
| Story | Planejamento e Lista de Compras | Adicionar ingredientes de uma receita para a lista | Highest | 3 |
| Story | Planejamento e Lista de Compras | Lista de compras colaborativa em tempo real | High | 8 |
| Story | Planejamento e Lista de Compras | Scanner de codigo de barras para adicionar ingrediente | Medium | 8 |
| Story | Planejamento e Lista de Compras | Notificacoes de promocoes por geolocalizacao | Low | 13 |
| Epic | Inteligencia e Recomendacoes | EPIC-04 - Inteligencia e Recomendacoes | High | |
| Story | Inteligencia e Recomendacoes | Sugestao de receitas com base em historico e clima | High | 8 |
| Story | Inteligencia e Recomendacoes | Sugestao de substituicao de ingredientes por restricao | High | 5 |
| Story | Inteligencia e Recomendacoes | Reconhecimento de ingredientes por foto com ML Kit local | High | 13 |
| Story | Inteligencia e Recomendacoes | Busca por voz com filtros de intencao | High | 5 |
| Epic | Experiencia de Preparo | EPIC-05 - Experiencia de Preparo | Highest | |
| Story | Experiencia de Preparo | Timer por etapa com alerta por vibracao | Highest | 3 |
| Story | Experiencia de Preparo | Modo maos ocupadas com comandos de voz | High | 8 |
| Story | Experiencia de Preparo | Modo chef com tela ativa e prevencao de toque acidental | Medium | 5 |
| Story | Experiencia de Preparo | Modo noturno automatico por sensor de luz | Medium | 5 |
| Epic | Social, Comunidade e Compartilhamento | EPIC-06 - Social, Comunidade e Compartilhamento | High | |
| Story | Social, Comunidade e Compartilhamento | Compartilhamento de receita via QR Code e deep link | High | 8 |
| Story | Social, Comunidade e Compartilhamento | Compartilhamento do planejamento semanal em imagem | Medium | 5 |
| Story | Social, Comunidade e Compartilhamento | Sistema de cozinheiros do mes com ranking | Low | 8 |
| Story | Social, Comunidade e Compartilhamento | Votacao de dificuldade e tempo real das receitas | Medium | 5 |
| Epic | Offline e Sincronizacao | EPIC-07 - Offline e Sincronizacao | Highest | |
| Story | Offline e Sincronizacao | Download de receitas com midia para uso offline completo | Medium | 13 |
| Story | Offline e Sincronizacao | Cache inteligente de receitas vistas e favoritas | Highest | 8 |
| Story | Offline e Sincronizacao | Edicao offline da lista de compras com sincronizacao | Highest | 8 |
| Epic | Arquitetura, API e Qualidade | EPIC-08 - Arquitetura, API e Qualidade | Highest | |
| Story | Arquitetura, API e Qualidade | API REST Node.js + Express + MongoDB para dominio principal | Highest | 13 |
| Story | Arquitetura, API e Qualidade | API versionada em /api/v1 e documentada com Swagger | Highest | 5 |
| Story | Arquitetura, API e Qualidade | Tempo real com Firebase Realtime Database ou WebSockets | High | 8 |
| Story | Arquitetura, API e Qualidade | Arquitetura modular por features no app | Highest | 8 |
| Story | Arquitetura, API e Qualidade | Testes de interface para fluxos criticos | High | 8 |
| Story | Arquitetura, API e Qualidade | Layout responsivo para celulares e tablets | High | 5 |
| Epic | Acessibilidade e Modos de Uso | EPIC-09 - Acessibilidade e Modos de Uso | Medium | |
| Story | Acessibilidade e Modos de Uso | Modo crianca com interface simplificada | Medium | 5 |
| Epic | Analytics e Crescimento | EPIC-10 - Analytics e Crescimento | High | |
| Story | Analytics e Crescimento | Analytics anonimo com consentimento do usuario | High | 5 |
